        ...
        <div className="row g-4">
          <div className="col-lg-4">
            <div className="footer-logo mb-3">
              <img src="assets/logo-mark-white.png" alt="" width="68" height="36" />
              Metal Hunters
            </div>
            <p className="text-grey">Streetwear for the urban, graffiti and writer scene. Limited drops, halftone prints, underground culture. Raw since 2015.</p>
            <div className="mt-3">
              <a href="#" className="mh-social" aria-label="Instagram">
              ...
              <a href="#" className="mh-social" aria-label="TikTok">
              ...
              <a href="#" className="mh-social" aria-label="YouTube">
          ...
          <div className="col-6 col-lg-2">
            ...
            <Link className="footer-link" to="/hall-of-fame">Hall of Fame</Link>
          ...
          <div className="col-lg-4">
            <h6>Contact</h6>
            <p className="footer-link mb-1">15 Tag Street, Milan, IT</p>
            <p className="footer-link mb-1">info@metalhunters.com</p>
            <p className="footer-link mb-1">+39 02 1234 5678</p>
          </div>
        </div>
        <hr className="my-4" />
        <div className="d-flex flex-wrap justify-content-between gap-2">
          <p className="text-grey small mb-0">&copy; 2026 Metal Hunters. All rights reserved.</p>
          <p className="text-grey small mb-0">Mock-up designed for demonstration purposes.</p>
        </div>
      </div>
    </footer>
  );
